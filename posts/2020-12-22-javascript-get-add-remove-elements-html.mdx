...
<ul>
	...
	<li>
		<a href='https://byrayray.dev/posts/2017-10-jquery-will-not-help-you-learn-javascript/' rel='noopener'>
			jQuery is not gonna help you learn JavaScript
		</a>
	</li>
	<li>
		<a href='https://byrayray.dev/posts/2017-10-write-better-css-with-bem/' rel='noopener'>
...
For example, we want to find the header with a class "<strong>header\_\_main</strong>". (as you maybe notice, I used the <a href="https://byrayray.dev/posts/2017-10/write-better-css-with-bem/">template from the BEM video</a>).
