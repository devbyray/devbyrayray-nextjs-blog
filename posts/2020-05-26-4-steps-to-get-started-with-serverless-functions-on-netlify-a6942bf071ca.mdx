...
published: true
tags: []
cover_image: https://cdn-images-1.medium.com/max/800/0*h-Oc-BQ3UWnRKq_z
# slug: >-
#   /@devbyrayray/4-steps-to-get-started-with-serverless-functions-on-netlify-a6942bf071ca
---

<small class="credits">_Photo by [Christina @ wocintechchat.com](https://unsplash.com/@wocintechchat?utm_source=medium&utm_medium=referral) on [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral)._</small>
