...
image: https://res.cloudinary.com/raymons/image/upload/v1609097377/devbyrayray/blog/TailWind%20CSS%20%2B%20NextJS%20%3D%20Web%C2%A0Dev.jpg
---
...
**Currently, your reading this post on my blog (or on Medium/Dev.to, here is the link 😉) on which I've used Tailwind CSS. I have to say, and I'm convinced to use it in more of my web development projects.**
...
Compare Tailwind CSS to a CSS framework like Bootstrap or Foundation, and you will find out that it's completely different.
