...
1. [Why use Tailwind CSS?](#1-why-use-tailwind-css)
2. [You have to know CSS!](#2-you-have-to-know-css)
3. [How to add Tailwind CSS to NextJS](#3-how-to-add-tailwind-css-to-nextjs)
4. [How To Use Tailwind CSS](#4-how-to-use-tailwind-css)
