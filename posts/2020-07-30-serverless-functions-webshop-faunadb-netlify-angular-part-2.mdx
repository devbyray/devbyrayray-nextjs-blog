...
## cover_image: <https://miro.medium.com/max/1280/0*cAnIYaAnz3zzWt5t>
...
1.  Connect Angular and [FaunaDB](https://dashboard.fauna.com/accounts/register?utm_source=ByRayRay&utm_medium=referral&utm_campaign=WritewithFauna_BuildServerlessWebshopWorkshop_part2_Raymon) with Netlify Serverless functions
...
1.  [TypeScript’s New Top-Level Await](https://byrayray.dev/type-script-s-new-top-level-await/)
2.  [4 Steps to Get Started With Serverless Functions on Netlify](https://byrayray.dev/4-steps-to-get-started-with-serverless-functions-on-netlify/)
3.  [Native Lazy Loading in the Browser](https://byrayray.dev/native-lazy-loading-in-the-browser/)
