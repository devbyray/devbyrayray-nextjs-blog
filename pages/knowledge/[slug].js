...
import { knowledgeFilePaths, KNOWLEDGE_PATH, getMdxPaths } from '../../utils/mdxUtils'
...
export const getStaticProps = async ({ params }) => {
    const postFilePath = path.join(KNOWLEDGE_PATH, `${params.slug}.mdx`)
...
export const getStaticPaths = async () => {
    return getMdxPaths(knowledgeFilePaths)
}
